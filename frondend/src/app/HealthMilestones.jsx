  ...
  return (
    ...
    >
      ...
      > 
        ...
        {/* Cột mốc: 20 phút */}
        <div
          className={`milestone-col ${milestones['20 minutes'] ? 'achieved' : ''}`}
          onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = '#e6ffe6')} // Hiệu ứng hover: nền xanh nhạt
          onMouseLeave={(e) =>
            (e.currentTarget.style.backgroundColor = milestones['20 minutes'] ? '#e6ffe6' : '#fff')
          } // Khôi phục màu nền dựa trên trạng thái đạt được
        >
          <span className="milestone-icon"></span> {/* Placeholder cho biểu tượng cột mốc */}
          <div>
            <strong>20 minutes</strong>
            <p>Your heart rate and blood pressure drop</p>
          </div>
          <span className="status">{getStatus('20 minutes')}</span> {/* Hiển thị trạng thái */}
        </div>
         

        {/* Cột mốc: 12 giờ */}
        <div
          className={`milestone-col ${milestones['12 hours'] ? 'achieved' : ''}`}
          onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = '#e6ffe6')}
          onMouseLeave={(e) =>
            (e.currentTarget.style.backgroundColor = milestones['12 hours'] ? '#e6ffe6' : '#fff')
          }
        >
        ...
        {/* Cột mốc: 2-3 tuần */}
        <div
          className={`milestone-col ${milestones['2-3 weeks'] ? 'achieved' : ''}`}
          onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = '#e6ffe6')}
          onMouseLeave={(e) =>
            (e.currentTarget.style.backgroundColor = milestones['2-3 weeks'] ? '#e6ffe6' : '#fff')
          }
        >
          <span className="milestone-icon"></span>
          <div>
        ...
        {/* Cột mốc: 1-3 tháng */}
        <div
          className={`milestone-col ${milestones['1-3 months'] ? 'achieved' : ''}`}
          onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = '#e6ffe6')}
          onMouseLeave={(e) =>
            (e.currentTarget.style.backgroundColor = milestones['1-3 months'] ? '#e6ffe6' : '#fff')
          }
        >
          <span className="milestone-icon"></span>
          <div>
